...
def ensemble_classifier(dataset_path, datasetname, save_model=False, features=None, random_state=42):
        ...
        for name, model in models.items():
            ...
            try:
                ...
                if hasattr(model, 'predict_proba'):
                    ...
                    results_csv = os.path.join(results_dir, f"{timestamp}_{datasetname}_{name}_predictions.csv")
...
if __name__ == '__main__':
    ...
    datasets = [
        "datasets/trainning_Datasets/LinkedIn people profiles datasets - Clean_label_data_NoAI.csv",
        "datasets/trainning_Datasets/LinkedIn people profiles datasets - Clean_Original_label_data.csv",
    ]
